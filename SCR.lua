...
--Do Tween
local function DoTween(dist, Speed)
...
local function KillAuraF()
   for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
      if v.Parent and v:FindFirstChild("LowerTorso") and v:FindFirstChild("Head") and v:FindFirstChild("UpperTorso") and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0 then
         ...
         pcall(function()
            if (v.HumanoidRootPart.Position - getRoot(Char).Position).magnitude < 1000 then
...
local function BringMobEctoplasm()
   if getgenv().AutoFarmBring and DoMagnet then
      if SecondSea then
         for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
            if v.Parent and v:FindFirstChild("HumanoidRootPart") ~= nil and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0  and not Tweening then
...
local function FixQuestCF()
   ...
   elseif HighestLvToFarm == 875 or HighestLvToFarm == 900 then
      QuestCFrame = CFrame.new(-2442.65015, 73.0511475, -3219.11523)
   elseif HighestLvToFarm == 950 or HighestLvToFarm == 975 then
...
spawn(function()
   while task.wait() do
      if getgenv().AutoBuso and not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
         local args = {
            [1] = "Buso"
         }
         game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
            ...
            if Alive() then
                  ...
                  if not FirstSea then
                     if not Tweening and not string.find(v.Name,"Boss") and getgenv().AutoFarm and string.find(v.Name,CurrentMobName) and string.find(v.Name,HighestLvToFarm) then
                        if v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and v.Parent and v:FindFirstChild("HumanoidRootPart") then
                           if SmallestDistance > (v.HumanoidRootPart.Position-game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart").Position).magnitude then
                              SmallestDistance = (v.HumanoidRootPart.Position-game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart").Position).magnitude
                              MobToFarm = v
                           end
                        end
               ...
               if not FirstSea then
                  ...
                  if TimesAutoFarm > 1 then
                     ...
                     MobToFarm.HumanoidRootPart.Size = Vector3.new(80,60,80)
                     DoMagnet = false
                     SecondPassed = 0
                     ...
                     TPSpecificPlace()
                     FixQuestCF()
                     DoTween(BringCFrame*CFrame.new(0,0,30),getgenv().TweenSpeedAutoFarm)
                     CheckFloat1()
                     --Set Spawn
                     ...
                     if MobToFarm.Parent and MobToFarm:FindFirstChild("Humanoid") and MobToFarm:FindFirstChild("Humanoid").Health > 0 and  MobToFarm:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and getgenv().AutoFarm then
                        DisabledNoClip = true
                        DoTween(MobToFarm.HumanoidRootPart.CFrame * CFrame.new(0,0,30),getgenv().TweenSpeedAutoFarm)
                        CheckFloat1()
                     ...
                     repeat task.wait()
                        if Alive() then
                           ...
                           if MobToFarm and MobToFarm:FindFirstChild("Humanoid") and MobToFarm:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and MobToFarm:FindFirstChild("Humanoid").Health > 0 and (MobToFarm.HumanoidRootPart.Position-HumanoidRootPart.Position).magnitude <= 300 then
                              ...
                              if game.Players.LocalPlayer.Character.HumanoidRootPart.Position.y - MobToFarm.HumanoidRootPart.Position.y > -5  then
                                       ...
                                       if getgenv().AutoFarmGunMastery then
                                          if MobP and MobHumanoid and MobHRP then
                                             if Alive() and MobHumanoid.Health > 0 and (MobHRP.Position-HumanoidRootPart.Position).magnitude <= 300 then
                                                ...
                                                HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(x, getgenv().Y, z)
                                             else
                                                DoTween(v.HumanoidRootPart.CFrame * CFrame.new(0,30,0),getgenv().TweenSpeedAutoFarm)
                                             end
                                          end
               ...
               if v then
                  ...
                  if BossLevel ~= nil and PlrLevel ~= nil then
                     if getgenv().AutoAllBoss and v.Name ~= "Longma [Lv. 2000] [Boss]" and v.Name ~= "Order [Lv. 1250] [Raid Boss]" and v.Name ~= "Cursed Captain [Lv. 1325] [Raid Boss]" and v.Name ~= "rip_indra [Lv. 1500] [Boss]" and v.Name ~= "Ice Admiral [Lv. 700] [Boss]" and tonumber(BossLevel) <= PlrLevel and string.find(v.Name,"Boss") then
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid").Health > 0 and (v.HumanoidRootPart.Position-HumanoidRootPart.Position).magnitude < NearestDist then
                           NearestBoss = v
                           NearestDist =  (v.HumanoidRootPart.Position-HumanoidRootPart.Position).magnitude
                        end
                     end
                  end
               end
               ...
               repeat wait()
                  ...
                  if Alive() then
                     ...
                     if getgenv().AutoAllBoss and NearestBoss.Parent and NearestBoss:FindFirstChild("Humanoid") and NearestBoss:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and NearestBoss:FindFirstChild("Humanoid").Health > 0 and (NearestBoss.HumanoidRootPart.Position-HumanoidRootPart.Position).magnitude <= 300 then
                        ...
                        if game.Players.LocalPlayer.Character.HumanoidRootPart.Position.y - NearestBoss.HumanoidRootPart.Position.y > -3 then
                     ...
                     elseif not Tweening and NearestBoss:FindFirstChild("HumanoidRootPart") ~= nil and NearestBoss.Parent and NearestBoss:FindFirstChild("Humanoid") and NearestBoss:FindFirstChild("Humanoid").Health > 0 and Alive() then  
                        DoTween(NearestBoss.HumanoidRootPart.CFrame* CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                        if NearestBoss.Parent and NearestBoss:FindFirstChild("Humanoid") and NearestBoss:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and NearestBoss:FindFirstChild("Humanoid").Health > 0 and (NearestBoss.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude > 300 then
                           DoTween(NearestBoss.HumanoidRootPart.CFrame* CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                        end
                     end
                  else wait(5)
         ...
         if MobObservation ~= nil and PosObservation ~= nil then
            if game.Workspace.Enemies:FindFirstChild(MobObservation) then
               if game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                  ...
                  repeat wait()
                     if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-game.Workspace.Enemies:FindFirstChild(MobObservation).HumanoidRootPart.Position).magnitude < 300 then
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Enemies:FindFirstChild(MobObservation).HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                     else
                        DoTween(game.Workspace.Enemies:FindFirstChild(MobObservation).HumanoidRootPart.CFrame* CFrame.new(3,0,0),getgenv().TweenSpeedAutoFarm)
                     end
                  ...
                  repeat wait()
                     if not  game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                        CheckFloat1()
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-game.Workspace.Enemies:FindFirstChild(MobObservation).HumanoidRootPart.Position).magnitude < 300 then
                           game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Enemies:FindFirstChild(MobObservation).HumanoidRootPart.CFrame * CFrame.new(30,30,30)
                        else
                              ...
                              repeat wait()
                                 if getgenv().AutoFarm2 then
                                    ...
                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                       if not Tweening and not string.find(v.Name,"Boss") and getgenv().AutoFarm2 and v.Name == NameMob then
                                          if v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and v.Parent and v:FindFirstChild("HumanoidRootPart") and (v.HumanoidRootPart.Position-FarmingPlace1.Position).magnitude <= 450 then
                                             v.HumanoidRootPart.CFrame = FarmingPlace1*CFrame.new(math.random(1,3),0,math.random(1,3))
                                             v.HumanoidRootPart.CanCollide = false
                                             v.HumanoidRootPart.Size = Vector3.new(60,60,60)
                                             spawn(function()
                                                for i2,v2 in pairs(v:GetChildren()) do
                              ...
                              repeat wait()
                                 if getgenv().AutoFarm2 then
                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                       if not Tweening and not string.find(v.Name,"Boss") and getgenv().AutoFarm2 and v.Name == NameMob then
                                          if v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 and v.Parent and v:FindFirstChild("HumanoidRootPart") and (v.HumanoidRootPart.Position-FarmingPlace2.Position).magnitude <= 350 then
                                             v.HumanoidRootPart.CFrame = FarmingPlace2*CFrame.new(math.random(1,3),0,math.random(1,3))
                                             v.HumanoidRootPart.CanCollide = false
                                             v.HumanoidRootPart.Size = Vector3.new(60,60,60)
                                             spawn(function()
                                                for i2,v2 in pairs(v:GetChildren()) do
   ...
   while getgenv().MobAura and task.wait() do
      ...
      for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
         if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0 then
            if (v.HumanoidRootPart.Position-getRoot(Char).Position).magnitude <= 3000 then
               if (v.HumanoidRootPart.Position-getRoot(Char).Position).magnitude < NearestDist then
                  NearestDist = (v.HumanoidRootPart.Position-getRoot(Char).Position).magnitude
                  NearestMob = v
               end
            end
         end
      ...
      for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
         if v.Name == BossName then
            ...
            if v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0 and  v:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and getgenv().KillingBoss then
               DisabledNoClip = true
               DoTween(v.HumanoidRootPart.CFrame * CFrame.new(0,40,10),getgenv().TweenSpeedAutoFarm)
               DisabledNoClip = false
            end
            repeat wait()
               if Alive() then
                  ...
                  if v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and v:FindFirstChild("Humanoid").Health > 0 then
                     v.HumanoidRootPart.CanCollide = false
                     v.HumanoidRootPart.Size = Vector3.new(300,300,300)
                     if (v.HumanoidRootPart.Position-getRoot(Char).Position).magnitude <= 300 then

                        if getRoot(Char).Position.y - v.HumanoidRootPart.Position.y > -3 then
                           if v.HumanoidRootPart.Position.Y - OldY >= 0 then
                              spawn(function()
                                 wait()
                                 if getgenv().KillingBoss and v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") ~= nil then
                                    if Alive() and v:FindFirstChild("Humanoid").Health > 0 and (v.HumanoidRootPart.Position-getRoot(Char).Position).magnitude <= 300 then
                                       CheckFloat1()
                                       getRoot(Char).CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0, 40, 40)
                                    else
                                       DoTween(v.HumanoidRootPart.CFrame * CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                                    end
                                 end
                        ...
                        elseif getgenv().KillingBoss then
                           local randomnumber = math.random(1,3)
                           if randomnumber == 1 then
                              getRoot(Char).CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0, 0, 50)      
                           elseif randomnumber ==2 then
                              getRoot(Char).CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0, 0, -50) 
                           elseif randomnumber ==3 then
                              getRoot(Char).CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0, -50, 0)
                           end    
                        end
                     ...
                     elseif not Tweening and v:FindFirstChild("HumanoidRootPart") ~= nil and v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("Humanoid").Health > 0 and Alive() then  
                        DoTween(v.HumanoidRootPart.CFrame*CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                        if v.Parent and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") ~= nil and Alive() and v:FindFirstChild("Humanoid").Health > 0 and (v.HumanoidRootPart.Position-getRoot(Char).Position).magnitude > 300 then
                           DoTween(v.HumanoidRootPart.CFrame*CFrame.new(0,40,40),getgenv().TweenSpeedAutoFarm)
                        end
                     end
                  end
...
if SecondSea then
   ...
   CheckEctoplasm = AutoFarmEvent:addButton("Ectoplasm: N/A",function()
   end)
      ...
      while getgenv().AutoFactory and wait() do
         pcall(function()
            ...
            if Factory then
               ...
               if  Factory:FindFirstChild("Humanoid") and Factory.Humanoid.Health > 0 then
                  if getgenv().AutoFarm then
                     getgenv().AutoFarm = false
                     ChangeAF = true
                  end
                  if (HumanoidRootPart.Position - Vector3.new(448.46756, 199.356781, -441.389252)).magnitude > 10 then
                     DoTween(CFrame.new(448.46756, 199.356781, -441.389252),getgenv().TweenSpeedTeleportPlace)
                  else
                  repeat wait()
                     Equip(Weapon)
                     Click()                    
                  until not v or not v:FindFirstChild("Humanoid") or v.Humanoid.Health <= 0  or not getgenv().AutoFactory or (HumanoidRootPart.Position - Vector3.new(448.46756, 199.356781, -441.389252)).magnitude<= 10
...
if ThirdSea then
   ...
   CheckBone = AutoFarmEvent:addButton("Bone: N/A",function()
   end)
                        ...
                        if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 and getgenv().AutoFarmCandy then
                           ...
                           if MobToFarmCandy.Parent and MobToFarmCandy:FindFirstChild("Humanoid") and MobToFarmCandy:FindFirstChild("Humanoid").Health > 0 and  MobToFarmCandy:FindFirstChild("HumanoidRootPart") ~= nil and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 and MobToFarmCandy:FindFirstChild("Humanoid").Health > 0 and (MobToFarmCandy.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300 then
                              spawn(function()
                                 ...
                                 HitBoxPlr()
                                 if game.Players.LocalPlayer.Character.HumanoidRootPart.Position.y - MobToFarmCandy.HumanoidRootPart.Position.y > -3 then
                                       ...
                                       spawn(function()
                                          ...
                                          if getgenv().AutoFarmCandy and MobToFarmCandy.Parent and MobToFarmCandy:FindFirstChild("Humanoid") and MobToFarmCandy:FindFirstChild("Humanoid").Health > 0 and  MobToFarmCandy:FindFirstChild("HumanoidRootPart") ~= nil then
                                             if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 and MobToFarmCandy:FindFirstChild("Humanoid").Health > 0 and (MobToFarmCandy.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300 then
                                                CheckFloat1()
                                                game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = MobToFarmCandy.HumanoidRootPart.CFrame * CFrame.new(0, 0, 30)
                                             else
                                                DoTween(MobToFarmCandy.HumanoidRootPart.CFrame * CFrame.new(0,0,30),getgenv().TweenSpeedAutoFarm)
                                                CheckFloat1()
                                             end
                                    ...
                                    if randomnumber == 1 and getgenv().AutoFarmCandy  then
                                       game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = MobToFarmCandy.HumanoidRootPart.CFrame * CFrame.new(0, 30, 0)      
   ...
   CheckDimension = AutoFarmEvent:addButton("Dimension: N/A kills",function()
   end)
   ...
   CheckKillElite = AutoFarmEvent:addButton("Elite Kill: N/A",function()
   end)
   AutoFarmEvent:addToggle("Auto Pirate Raid",false,function(boolen)
      ...
      while getgenv().AutoPirateRaid and wait() do
         for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
            if (v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v:IsA("Model") and (v.HumanoidRootPart.Position-CenterCastle).magnitude <= 1000) then
               ...
               repeat wait()
                  ...
                  if HumanoidRootPart.Position.y >= MobPirateRaid.HumanoidRootPart.Position.y then
                     ...
                     if getgenv().AutoPirateRaid then
                        ...
                        if randomnumber == 1 then
                           CheckFloat1()
                           game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = MobPirateRaid.HumanoidRootPart.CFrame * CFrame.new(0, 0, 30)      
                        elseif randomnumber ==2 then
                           CheckFloat1()
                           game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = MobPirateRaid.HumanoidRootPart.CFrame * CFrame.new(0, 0, -30) 
                        elseif randomnumber ==3 then
                           CheckFloat1()
                           game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = MobPirateRaid.HumanoidRootPart.CFrame * CFrame.new(0, -30, 0)
                        end    
                     end
                  end
            ...
            if TalkedSon and not KilledMob and getgenv().AutoSaber and UsedTorch and UsedCup then
               if game.Workspace.Enemies:FindFirstChild("Mob Leader [Lv. 120] [Boss]") then
                  ...
                  repeat wait(.1)
                     ...
                     pcall(function()
                        --HitBoxPlr()
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MobLeader.HumanoidRootPart.Position) <= 350 then
            ...
            if not KilledShanks and getgenv().AutoSaber and UsedRelic and UsedTorch and UsedCup and KilledMob  then
               if game.Workspace.Enemies:FindFirstChild("Saber Expert [Lv. 200] [Boss]") then
                  ...
                  repeat wait()
                     ...
                     pcall(function()
                       -- HitBoxPlr()
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Shank.HumanoidRootPart.Position) <= 350 then
            ...
            if not KilledIceBoss and UsedKey then
               ...
               if game.Workspace.Enemies:FindFirstChild("Ice Admiral [Lv. 700] [Boss]") then
                  ...
                  repeat wait(0.1)
                     ...
                     pcall(function()
                        --HitBoxPlr()
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - IceAdmiral.HumanoidRootPart.Position) <= 350 then
         ...
         elseif not KilledCaptainElephantCitizen and getgenv().AutoCitizenQuest then
            if game.Workspace.Enemies:WaitForChild("Captain Elephant [Lv. 1875] [Boss]") then
               ...
               repeat wait()
                  ...
                  pcall(function()
                     --HitBoxPlr()
                     if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CaptainElephant.HumanoidRootPart.Position) <= 350 then
         ...
         --if PlrLevel >= 2000 then
            ...
            if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args1)),"Stone") then
               ...
               repeat wait()
                  ...
                  pcall(function()
                     HitBoxPlr()
                     if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - StoneBoss.HumanoidRootPart.Position) <= 350 then
            ...
            elseif string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args1)),"Island Empress") then
               ...
               repeat wait()
                  ...
                  pcall(function()
                     HitBoxPlr()
                     if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - IslandEmpress.HumanoidRootPart.Position) <= 350 then
                     ...
                     game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = IslandEmpress.HumanoidRootPart.CFrame * CFrame.new(0,20,0)
                     IslandEmpress.HumanoidRootPart.Size = Vector3.new(60,60,60)
            ...
            elseif string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args1)),"Kilo Admiral") then
               ...
               repeat wait()
                  ...
                  pcall(function()
                     ...
                     if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - KiloAdmiral.HumanoidRootPart.Position) <= 350 then
            ...
            elseif string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args1)),"Beautiful Pirate") then
               ...
               repeat wait()
                  ...
                  pcall(function()
                     if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - BeautifulPirate.HumanoidRootPart.Position) <= 350 then
...
CheckKenHaki = AutoStuffs:addButton("Ken Exp: N/A",function()
end)
if ThirdSea then
...
if not FirstSea then
   TeleportSection:addButton("Teleport to Sea Beast", function()
      ...
      pcall(function()
         DoTween(NearestSeaBeast.HumanoidRootPart.CFrame * CFrame.new(0,500,0),getgenv().TweenSpeedTeleportPlace)
      end)
   end)
end
               ...
               pcall(function()
                  if (getRoot(NearestMob).Position-getRoot(Char).Position).magnitude <= 350 then
                     ...
                     repeat wait()
                        ...
                        getRoot(NearestMob).CanCollide = false

                        getRoot(NearestMob).Size = Vector3.new(200, 50, 200)
                        if (getRoot(NearestMob).Position-getRoot(Char).Position).magnitude <= 350 then
...
Esp:addToggle("Esp Chests",false,function(Value)
   ...
   while getgenv().ChestESP and game:GetService("RunService").RenderStepped:wait(1) do
      for i,v in pairs(game.Workspace:GetChildren()) do
...
if getmusicasset then
   pcall(function()
Useless:addTextbox("Enter Id Music","Id Here",function(Value)
   if Value ~= nil or Value ~= "" then
      SongID = "rbxassetid://"..Value
   end
end)

Useless:addButton("Play Music",function()
...
Useless:addButton("Stop Music",function()
...
Useless:addDropdown("Select Music(Not Roblox Id)",allurlsong,function(Value)
   if Value ~= nil or Value ~= "" then
      SelectedSong = Value
      DefaultSong = false
...
Useless:addButton("Add Music To PathKrnl/workspace/Island/",function()
end)
Useless:addDropdown("Select Music(Not Default)",NotDefaultSong,function(Value)
...
spawn(function()
   while wait(1) do
      if SecondSea then
         AutoFarmEvent:updateButton(CheckEctoplasm,"Ectoplasm:"..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Ectoplasm","Check"))
         
      end
      AutoStuffs:updateButton(CheckKenHaki,"Ken Exp:"..game:GetService("Players")["LocalPlayer"].VisionRadius.Value)
      if ThirdSea then
         local args = {
            [1] = "CakePrinceSpawner",
            [2] = true
         ...
         local NumberKill1 = string.gsub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args)), "%D", "")
         local NumberKill2 = tonumber(NumberKill1) -500
         AutoFarmEvent:updateButton(CheckDimension,"Dimension:"..math.abs(NumberKill2).." kills")
         AutoFarmEvent:updateButton(CheckKillElite,"Elite Kill:"..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
         AutoFarmEvent:updateButton(CheckBone,"Bones:"..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check"))
      end
   end
end)
--[[
